...
% Grey Wolf Optimizer
function [Alpha_pos,Alpha_score,Convergence_curve]=GWO_func(fhd,Dimension,Particle_Number,Max_Gen,VRmin,VRmax,varargin)
dim=Dimension;
...
SearchAgents_no=Particle_Number;
ub=VRmax;
lb=VRmin;
Max_iter=Max_Gen;
